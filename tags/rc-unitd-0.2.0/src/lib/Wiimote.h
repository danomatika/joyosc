...
class Wiimote
{
    ...
    private:
        ...
        */
        ...
        inline string getClassicButtonName(int index);
	...
	uint16_t c_buttons;         // classic controller button prev state
	uint8_t c_l_stick[2];
	uint8_t c_r_stick[2];
    ...
    string classic_but_addr;    // osc address to external, addr + "/classic/button"
    string classic_axis_addr;   // osc address to external, addr + "/classic/axis"
