...
int DBus::setupSession(const char *name)
{
    return setup((char*) name, DBUS_BUS_SESSION);
}

int DBus::setupSystem(const char *name)
{
    return setup((char*) name, DBUS_BUS_SYSTEM);
}
...
int DBus::createSignal(const char *obj, const char *iface, const char *name)
{
    // create a signal & check for errors
    msg = dbus_message_new_signal((char*) obj, // object name of the signal
                                  (char*) iface, // interface name of the signal
...
int DBus::addMatchRule(const char *rule)
{
...
int DBus::removeMatchRule(const char *rule)
{
...
bool DBus::isSignal(const char *iface, const char *name)
{
